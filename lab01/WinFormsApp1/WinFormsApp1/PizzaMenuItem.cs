    ...
    public class PizzaMenuItem
    {
        ...
        public Panel CreatePanel(EventHandler addButtonClick)
        {
            ...
            if (File.Exists(imagePath))
            {
                ...
                pictureBox.Image = new Bitmap(img, new Size(170, 170));
                img.Dispose();
            }
            else
            {
                ...
                lblNoImage.Location = new Point(50, 70);
            ...
            lblName.Text = Name;
            lblName.Font = new Font("Arial", 18, FontStyle.Bold);
            lblName.Location = new Point(200, 15);
            ...
            lblBasePrice.Location = new Point(200, 45);
            ...
            lblToppings.Location = new Point(200, 80);
            lblToppings.AutoSize = true;
            panel.Controls.Add(lblToppings);

            int toppingStartX = 200;
            int toppingStartY = 110;
            int toppingSpacing = 180;

            NumMozzarella = CreateToppingControl(panel, "Моцарелла (60₽)", toppingStartX, toppingStartY);
            NumCheddar = CreateToppingControl(panel, "Чеддер (70₽)", toppingStartX + toppingSpacing, toppingStartY);
            NumPepperoni = CreateToppingControl(panel, "Пепперони (80₽)", toppingStartX + toppingSpacing * 2, toppingStartY);
            NumJalapeno = CreateToppingControl(panel, "Халапено (50₽)", toppingStartX + toppingSpacing * 3, toppingStartY);

            BtnAdd = new Button();
            BtnAdd.Text = "Добавить в заказ";
            BtnAdd.Size = new Size(180, 45);
            BtnAdd.Location = new Point(680, 75);
